...
// class Registrasi extends Core {
	...
	public function index()
	{
		...
		//CEK SUBMIT DATA
		if($this->input->post('pindah_idwarga')){
			//PROSES SIMPAN
			$data=array(
				'pindah_idwarga'=>$this->input->post('pindah_idwarga'),
				'pindah_alamatbaru'=>$this->input->post('pindah_alamatbaru'),
				'pindah_alamatlama'=>$this->input->post('pindah_alamatlama'),
			);
			########################################################
			// $file='reg_foto';
			// if($_FILES[$file]['name']){
	...
	public function tabel(){
		...
		//PROSES TAMPIL DATA
		$query=array(
			'select'=>'a.*,b.pendidikan_nama,c.norumah_nomor,c.norumah_keterangan,d.pindah_alamatbaru,d.pindah_alamatlama,d.pindah_id',
			...
			['tabel'=>'pindah d','ON'=>'d.pindah_idwarga=a.warga_id','jenis'=>'INNER']
			],
