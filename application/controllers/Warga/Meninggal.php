...
// class Registrasi extends Core {
	...
	//VARIABEL
	private $master_tabel="meninggal"; //Mendefinisikan Nama Tabel
	private $id="meninggal_id";	//Menedefinisaikan Nama Id Tabel
	private $default_url="Warga/Meninggal/"; //Mendefinisikan url controller
	private $default_view="Warga/Meninggal/"; //Mendefinisiakn defaul view
	...
	private function global_set($data){
		...
		if(isset($data['overwriteview'])){
			...
			$overwriteview="views/Warga/Meninggal/index.php";
			$menu_submenu='meninggal';
		}
		$data=array(
