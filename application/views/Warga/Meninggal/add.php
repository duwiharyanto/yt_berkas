					...
					<form id="forminput" class="formaction" method="POST" action="javascript:void(0)" url="<?= base_url($global->url)?>"  enctype="multipart/form-data">
						<div class="row">
							<div class="col-sm-12">		
								...
								<div class="form-group">
									<label>Tanggal</label>
									<input type="text" class="form-control datepicker" name="meninggal_tanggal" >
								</div>		
								<div class="form-group">
									<label>Keterangan</label>
									<textarea required type="text" name="meninggal_keterangan" class="form-control" title="Harus di isi" rows="5"></textarea>
								</div>			
							</div>
						</div>
						<div class="row">
