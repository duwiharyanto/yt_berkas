						...
						<div class="row">
							<div class="col-sm-12">		
								...
								<div class="form-group">
									...
									<textarea required type="text" name="pindah_alamatbaru" class="form-control" title="Harus di isi" rows="5"></textarea>
								</div>		
								<div class="form-group">
									<label>Alamat Lama</label>
									<textarea required type="text" name="pindah_alamatlama" class="form-control" title="Harus di isi" rows="5"></textarea>
								</div>																			
							</div>
						</div>
						<div class="row">
