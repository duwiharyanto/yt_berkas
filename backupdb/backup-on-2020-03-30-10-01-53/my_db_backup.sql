...
INSERT INTO `menu` (`menu_id`, `menu_nama`, `menu_ikon`, `menu_is_mainmenu`, `menu_link`, `menu_akses_level`, `menu_urutan`, `menu_status`, `menu_akses`, `menu_baru`, `menu_label`) VALUES (167, 'warga', 'flaticon-file', '0', 'Warga', '1', 5, '1', 1, NULL, NULL);
INSERT INTO `menu` (`menu_id`, `menu_nama`, `menu_ikon`, `menu_is_mainmenu`, `menu_link`, `menu_akses_level`, `menu_urutan`, `menu_status`, `menu_akses`, `menu_baru`, `menu_label`) VALUES (168, 'data_warga', 'flaticon-file', '167', 'Warga/Warga', '1', 1, '1', 1, NULL, NULL);
...
CREATE TABLE `warga` (
  ...
  `warga_nomorrumah` varchar(10) DEFAULT NULL,
  `warga_statustempattinggal` varchar(50) DEFAULT NULL,
  `warga_statusktp` varchar(50) DEFAULT NULL,
  `warga_domisili` varchar(50) DEFAULT NULL,
  `warga_jaminankesehatan` varchar(50) DEFAULT NULL,
  `warga_nomorjaminankesehatan` varchar(50) DEFAULT NULL,
  `warga_sktm` varchar(10) DEFAULT NULL,
  `warga_namakeluarga` varchar(200) DEFAULT NULL,
  `warga_alamatnamakeluarga` varchar(100) DEFAULT NULL,
  `warga_nohpkeluarga` varchar(15) DEFAULT NULL,
  `warga_nomorkk` int(100) DEFAULT NULL,
  `warga_nomorktp` int(100) DEFAULT NULL,
  `warga_nama` varchar(150) DEFAULT NULL,
  `warga_hubungankeluarga` varchar(50) DEFAULT NULL,
  `warga_alamatktp` text,
  `warga_jeniskelamin` varchar(50) DEFAULT NULL,
  `warga_tempatlahir` text,
  `warga_tanggallahir` date DEFAULT NULL,
  `warga_nomorhp` varchar(20) DEFAULT NULL,
  `warga_statusnomor` varchar(50) DEFAULT NULL,
  `warga_email` varchar(50) DEFAULT NULL,
  `warga_agama` varchar(50) DEFAULT NULL,
  `warga_golongandarah` varchar(5) DEFAULT NULL,
  `warga_hobi` varchar(255) DEFAULT NULL,
  `warga_statusperkawainan` varchar(50) DEFAULT NULL,
  `warga_pendidikanterakhir` varchar(50) DEFAULT NULL,
  `warga_pekerjaan` varchar(100) DEFAULT NULL,
  `warga_alamatbekerja` text,
  `warga_npwp` varchar(20) DEFAULT NULL,
  `warga_nonpwp` varchar(50) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`warga_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

INSERT INTO `warga` (`warga_id`, `warga_nomorrumah`, `warga_statustempattinggal`, `warga_statusktp`, `warga_domisili`, `warga_jaminankesehatan`, `warga_nomorjaminankesehatan`, `warga_sktm`, `warga_namakeluarga`, `warga_alamatnamakeluarga`, `warga_nohpkeluarga`, `warga_nomorkk`, `warga_nomorktp`, `warga_nama`, `warga_hubungankeluarga`, `warga_alamatktp`, `warga_jeniskelamin`, `warga_tempatlahir`, `warga_tanggallahir`, `warga_nomorhp`, `warga_statusnomor`, `warga_email`, `warga_agama`, `warga_golongandarah`, `warga_hobi`, `warga_statusperkawainan`, `warga_pendidikanterakhir`, `warga_pekerjaan`, `warga_alamatbekerja`, `warga_npwp`, `warga_nonpwp`, `created_at`) VALUES (3, '27', 'pribadi', 'modalan_RT.03', 'modalan_RT.03', 'tidak_ada', '', 'tidak', '', '', '', 2147483647, 2147483647, 'Supardi Hadi Warjono', 'Kepala Keluarga', 'Sesuai KTP modalan_RT.03', 'Laki-laki', 'Wonosari', '1957-09-06', '82322399941', 'Aktif Telepon', '', 'Kristen', '', '-', 'Menikah', 'SD', 'Buruh Harian Lepas', '-', 'tidak', '', '2020-03-30 14:48:33');
